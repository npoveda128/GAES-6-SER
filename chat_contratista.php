...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    if (isset($_GET["eliminar"])) {
        ...
        if ($result == true) {
            ...
            header("Location: chat_contratista.php?id_chat=$id_chat");
...
<head>
    ...
    <script>
        function ajax() {
            ...
            req.open('GET', 'chat.php?id_chat=' + getUrl.get('id_chat') + '&rol=Contratista', true);
            req.send();
        }
    ...
    switch ($_GET["alert"]) {
        case '1':
            echo "<script>
                            Swal.fire({
                            icon: 'success',
                            title: 'Has contratado un servicio, ahora puedes chatear con el ofertante.',  
                            })
                    </script>";
            break;
        default:
                ...
                <div class="row">
                            ...
                            <div class="list-group lg-alt">
                                ...
                                ?>
                                    <a class="list-group-item media" style="background: <?php if ($row["estado"] == 3) echo "antiquewhite";
                                                                                        elseif ($row["estado"] == 2) echo "aliceblue"; ?>;" href="chat_contratista.php?id_chat=<?php echo $row['id_chat']; ?>&rol=Contratista">
                                        <div class="pull-left">
                    ...
                    <div class="col-md-9">
                        <div class="ms-body">
                            <div class="action-header clearfix">
                                ...
                                <?php if (isset($_GET["id_chat"]) && !empty($_GET["id_chat"])) { ?>
                                    ...
                                    <ul class="ah-actions actions">
                                        <li>
                                            <a href="chat_contratista.php?eliminar=<?php echo $id_chat; ?>">
                                                <i class="fa fa-trash"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="chat_contratista.php?finalizar=<?php echo $id_chat; ?>">
                                                <i class="fa fa-check"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="chat_contratista.php?bloquear=<?php echo $id_chat; ?>">
                            ...
                            ?>
                                    <div class="msb-reply">
                                        <form action="chat_contratista.php?id_chat=<?php echo $_GET["id_chat"]; ?>&rol=Contratista" method="POST">
