        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          if (isset($_POST["agregar"])) {
            ...
            if ($result == true) {
              ...
              header("Location: portafolio.php?alert=1");
            ...
            if ($result == true) {
              ...
              header("Location: portafolio.php?alert=2");
          ...
          if (isset($_GET["eliminar"])) {
            ...
            if ($result == true) {
              ...
              header("Location: portafolio.php?alert=3");
                          ...
                          <div class="postcard__text">
                            ...
                            <?php
                              ...
                              ?>
                                <div class="star-wrapper">
                                  <a href="#" class="fas fa-star <?php if($estrellas > 0) {echo "s"; $estrellas = $estrellas - 1;}?>"></a>
                                  <a href="#" class="fas fa-star <?php if($estrellas > 0) {echo "s"; $estrellas = $estrellas - 1;}?>"></a>
                                  <a href="#" class="fas fa-star <?php if($estrellas > 0) {echo "s"; $estrellas = $estrellas - 1;}?>"></a>
                                  <a href="#" class="fas fa-star <?php if($estrellas > 0) {echo "s"; $estrellas = $estrellas - 1;}?>"></a>
                                  <a href="#" class="fas fa-star <?php if($estrellas > 0) {echo "s"; $estrellas = $estrellas - 1;}?>"></a>
                            ...
                            <ul class="postcard__tagbox">
                              ...
                              <li class="tag__item play red">
                                <a href="portafolio.php?editar=<?php echo $row['id_servicio']; ?>"><i class="fas fa-play mr-2"></i>EDITAR</a>
                              </li>
                              <li class="tag__item play red">
                                <a href="portafolio.php?eliminar=<?php echo $row['id_servicio']; ?>"><i class="fas fa-play mr-2"></i>ELIMINAR</a>
                              </li>
                            </ul>
                          </div>
                        </article>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form class="row g-3" action="portafolio.php" method="POST">
                    <?php
                    ...
                    ?>
                        ...
                        <input type="text" value="<?php echo $_SESSION["id_persona"]; ?>" name="id_persona" hidden>
                        <div class="col-md-6">
