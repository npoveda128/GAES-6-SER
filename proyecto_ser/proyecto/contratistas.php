        ...
        ('$nombres', '$apellidos', '$fecha_nacimiento', '$numero_documento', '$tipo_documento', $estado);";
            ...
            ($id_persona, '$email', '$password', '$rol', $estado);";
                            ...
                            if ($result == true) {
                                ...
                                header("Location: contratistas.php?alert=1");
            ...
            where id_persona = $id_persona;";
                ...
                where id_usuario = $id_usuario;";
                            ...
                            if ($result == true) {
                                header("Location: contratistas.php?alert=2");
            ...
            where id_usuario = $id_usuario;";
                            ...
                            if ($result == true) {
                                ...
                                header("Location: contratistas.php?alert=3");
                ...
                $sql = "select id_usuario, persona.id_persona, email, rol, usuario.estado, nombres, apellidos, numero_documento, tipo_documento from usuario inner join persona on usuario.id_persona = persona.id_persona where usuario.rol = 'Contratista';";
                ...
                if (isset($_GET["alert"])) {
                    ...
                    switch ($_GET["alert"]) {
                        case '1':
                            ...
                            Swal.fire({
                            icon: 'success',
                            title: 'Se ha registrado correctamente el contratista',  
                            })
                    </script>";
                            break;
                        case '2':
                            ...
                            Swal.fire({
                            icon: 'success',
                            title: 'Se ha modificado correctamente el contratista',  
                            })
                    </script>";
                            break;
                        case '3':
                            ...
                            Swal.fire({
                            icon: 'success',
                            title: 'Se ha eliminado correctamente el contratista',  
                            })
                    </script>";
                            break;
                        case '4':
                            ...
                            <main class="col-md-12 col-sm-12 overflow-auto h-100">
                                <div class="bg-light border rounded-3 p-3">
                                    <div class="d-grid gap-2 pb-5">
                                        <button class="btn btn-primary" id="modal" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Agregar Contratista</button>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="contratistas.php?editar=<?php echo $row['id_usuario']; ?>">Editar</a> | <a href="contratistas.php?eliminar=true&id_usuario=<?php echo $row['id_usuario']; ?>&id_persona=<?php echo $row['id_persona']; ?>">Eliminar</a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Agregar Contratista</h5>
                                    <a class="btn-close" aria-label="Close" href="contratistas.php" role="button"></a>
                                </div>
                                <div class="modal-body">
                                    <form class="row g-3" action="contratistas.php" method="POST">
                                        <?php
                                        ...
                                        <div class="modal-footer">
                                            <a class="btn btn-secondary" href="contratistas.php" role="button">Cerrar</a>
